...
{
public:
  // Q_DECL_CONSTEXPR IS A MACRO THAT IS USED WHEN A VARIABLE SHOULD BE CONSTRUCTED ON COMPILATION TIME, OR A FUNCTION THAT CAN BE COMPUTADED AT COMPILE TIME
  // Constructors
