...
Vertex3D verts[] = {Vertex3D(0.00f,  0.75f, 1.0f, 0.0f, 0.0f, 1.0f),
                    Vertex3D(0.75f, -0.75f, -0.5f, 0.0f, 0.0f, 1.0f),
                    Vertex3D(-0.75f, -0.75f, -0.5f, 0.0f, 0.0f, 1.0f),

                    Vertex3D(0.00f, -0.75f, 0.5f, 1.0f, 0.0f, 0.0f),
                    Vertex3D(0.75f,  0.75f, 0.5f, 1.0f, 0.0f, 0.0f),
                    Vertex3D(-0.75f,  0.75f, 0.5f, 1.0f, 0.0f, 0.0f)};
...
void OpenGLView::initializeGL(){
...

    {
        ...
        this->program->setAttributeBuffer(0, GL_FLOAT, Vertex3D::positionOffSet(),Vertex3D::positionSize,Vertex3D::stride());  // 0 - id
        ...
        // THIS FIRST IS TO READ VERTICES INFO
        this->program->setAttributeBuffer(1, GL_FLOAT, Vertex3D::colorOffSet(), Vertex3D::colorSize, Vertex3D::stride());  // 1 - id
                                                                    // GL_FLOAT - Variable type
...
//    glDrawArrays(GL_TRIANGLES, 0, 3);
    ...
    this->program->bind();
    {
        ...
        this->vertexArrayObject.bind();
        // DRAW AS TRIANGLES
        glDrawArrays(GL_TRIANGLES, 0, sizeof(verts) / sizeof(verts[0]));                         // glDrawArrays(MODE, FIRST, VERTICE_SIZE)
